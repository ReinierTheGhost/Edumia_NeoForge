...
public record EdumiaTreeFromStructureNBTConfig(ResourceLocation baseLocation, ResourceLocation canopyLocation,
                                               IntProvider height,
    ...
    public static final Codec<EdumiaTreeFromStructureNBTConfig> CODEC = RecordCodecBuilder.create(builder ->
            builder.group(
                    ResourceLocation.CODEC.fieldOf("base_location").forGetter(EdumiaTreeFromStructureNBTConfig::baseLocation),
                    ResourceLocation.CODEC.fieldOf("canopy_location").forGetter(EdumiaTreeFromStructureNBTConfig::canopyLocation),
                    IntProvider.CODEC.fieldOf("height").forGetter(EdumiaTreeFromStructureNBTConfig::height),
                    BlockStateProvider.CODEC.fieldOf("log_provider").forGetter(EdumiaTreeFromStructureNBTConfig::logProvider),
                    BlockStateProvider.CODEC.fieldOf("leaves_provider").forGetter(EdumiaTreeFromStructureNBTConfig::leavesProvider),
                    BLOCK_SET_CODEC.fieldOf("log_target").forGetter(EdumiaTreeFromStructureNBTConfig::logTarget),
                    BLOCK_SET_CODEC.fieldOf("leaves_target").forGetter(EdumiaTreeFromStructureNBTConfig::leavesTarget),
                    BlockPredicate.CODEC.fieldOf("can_grow_on_filter").forGetter(EdumiaTreeFromStructureNBTConfig::growableOn),
                    BlockPredicate.CODEC.fieldOf("can_leaves_place_filter").forGetter(EdumiaTreeFromStructureNBTConfig::leavesPlacementFilter),
                    Codec.INT.optionalFieldOf("max_log_depth", 5).forGetter(EdumiaTreeFromStructureNBTConfig::maxLogDepth),
                    TreeDecorator.CODEC.listOf().optionalFieldOf("decorators", new ArrayList<>()).forGetter(EdumiaTreeFromStructureNBTConfig::treeDecorators),
                    BLOCK_SET_CODEC.fieldOf("place_from_nbt").forGetter(EdumiaTreeFromStructureNBTConfig::placeFromNBT)
            ).apply(builder, EdumiaTreeFromStructureNBTConfig::new)
    );

    public EdumiaTreeFromStructureNBTConfig(ResourceLocation baseLocation, ResourceLocation canopyLocation,
