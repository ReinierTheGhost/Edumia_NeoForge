...
public class KapokTreeConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context){
        ...
        register(context, KAPOK_5,  EdumiaFeatures.TREE_FROM_NBT.get(), new TreeFromStructureNBTConfig(
                ...
                ModTags.Blocks.GROUND_MAHOGANY_SAPLING, 5, ImmutableList.of(new LeaveVineDecorator(0.5f),
                TrunkVineDecorator.INSTANCE),
                Set.of(Blocks.JUNGLE_LOG, ModNatureBlocks.JUNGLE_WOOD_FENCE.get(), ModNatureBlocks.JUNGLE_WOOD_STAIRS.get(),
                        ModNatureBlocks.JUNGLE_WOOD_SLAB.get(), WoodBlockSets.BANANA.leaves().get(), Blocks.MANGROVE_ROOTS, Blocks.JUNGLE_LEAVES)
        ));
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name){
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(Edumia.MOD_ID, "tree/tropical/kapok_tree/" + name));
    }
