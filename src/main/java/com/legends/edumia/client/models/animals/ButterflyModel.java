...
public class ButterflyModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition lWing = thorax.addOrReplaceChild("lWing", CubeListBuilder.create().texOffs(-4, 0)
				.addBox(0.0F, 0.0F, -4.5F, 20.0F, 0.0F, 27.0F,
						new CubeDeformation(0.0F)), PartPose.offset(1.2F, -1.0F, -1.0F));

		PartDefinition rWing = thorax.addOrReplaceChild("rWing", CubeListBuilder.create().texOffs(-4, 0)
				.mirror().addBox(-20.0F, 0.0F, -4.5F, 20.0F, 0.0F, 27.0F,
						new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-1.2F, -1.0F, -1.0F));
