...
public class MapWidget  extends ModWidget {
    protected final static double MAP_TO_WORLD_RATIO = (double) EdumiaMapConfigs.REGION_SIZE / EdumiaMapConfigs.FULL_MAP_SIZE;
    ...
    public Vector2d getMapPointFromMapCoordinate(Vector2d point){
        int mapSize = EdumiaMapConfigs.REGION_SIZE;
    ...
    public void moveTo(Vector2i worldCoordinates, Vector2d desiredZoomTargetMax){
        ...
        forcedCurrentMapCenterTargetRatio = new Vector2d(
                (double)worldCoordinates.x * MAP_TO_WORLD_RATIO / EdumiaMapConfigs.REGION_SIZE,
                (double)worldCoordinates.y * MAP_TO_WORLD_RATIO / EdumiaMapConfigs.REGION_SIZE
        );
